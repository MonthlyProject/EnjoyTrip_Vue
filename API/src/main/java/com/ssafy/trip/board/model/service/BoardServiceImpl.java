...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	public List<BoardDto> informlistArticle(Map<String, String> map) throws Exception {
		Map<String, Object> param = new HashMap<String, Object>();
		String key = map.get("key");
		if("user_id".equals(key))
			key = "b.user_id";
		...
		return boardMapper.informlistArticle(param);
	}
	...
	public BoardDto getArticle(int articleNo) throws Exception {
		...
		boardDto.setFileInfos(boardMapper.fileInfoList(articleNo));
		return boardDto;
	}
	...
	@Override
	public FileInfoDto getUserImg(int articleNo) throws Exception {
		return boardMapper.getUserImg(articleNo);
	}
